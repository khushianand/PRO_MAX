...
from tabs.generate_tracking.excel_writer.three_uk_qualys import is_three_uk_qualys_project
...
def _write_tracking_sheet(ws, df: pd.DataFrame, project: str, scanner: str, *, sheet_kind: str):
    if sheet_kind == "total" and is_three_uk_qualys_project(project, scanner):
        _write_dataframe_sheet(ws, df, project, scanner, blue_headers=QUALYS_BLUE_HEADERS)
        return
